...
<div class="container">
  <div class="row text-center">
      <div class="col-md-8 mb-4 page-title">
          <div class="page-title h1 text-start">
            <span class="underline">&nbsp;Res</span>ervation History
          </div>
      </div>
  </div>
  ...
  <div class="card mt-0 profile-card py-3 shadow mb-5 custom-padding">
          ...
          <div class="reservation-list">
            @foreach (array_reverse($future_reservations) as $future_reservation)
              <div class="row border border-2 border-orange rounded-5 mx-5 my-4 p-4 shadow">
                ...
                {{-- tinme --}}
                <div class="col-md mt-4 align-items-center">
                  <div class="row ms-4 mt-4 align-items-center">
                    <div class="col-sm">
                      <div class="row">
                        Start Time
                      </div>
                      <div class="row h5 text-center my-2 fw-bold max-amount  res-time">
                    ...
                    <div class="col-md">
                      <a
                        ...
                        class="btn btn-sm ad-btn rounded-pill px-3 btn-red-opposite fw-bold"
                      >
                          Cancel Reservation
                      </a>
                    </div>
