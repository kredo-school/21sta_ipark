...
@section('content')
    <div class="parking-place-list">
        <div class="row align-items-center mb-3">
            <div class="col h1 fw-bold title">
            ...
            <div class="col-2 text-end">
                <a href="javascript:void(0);" class="h1 filter-button">
                    ...
                    <div class="row">
                        <div class="col bg-white p-4 shadow m-3 border border-2 border-orange rounded-4">
                            <div class="row ms-0 me-2 d-flex align-items-center">
                                @if ($parking_place->isReservationPossible())
                                    <div
                                        class="col-2 bg-navy rounded-circle text-white shadow
                                                d-flex justify-content-center align-items-center status"
                                ...
                                <div class="col ms-1">
                                    <div class="row h4 fw-bold justify-content-center
                                                text-center parking-place-name"
                                    >
                                        <a
                                    ...
                                    <div class="row h6 justify-content-center text-center address">
                                        @if ($search)
                                ...
                                <div class="col-1 float-end h2">
                                    @guest
                                        <a
                                            ...
                                            style="color: #343A40;"
                                        >
                                            <i class="fa-regular fa-heart heart-button"></i>
                                        </a>
                                    @else
                            ...
                            <div class="row mt-3 justify-content-center">
                                @if ($parking_place->daytime_from == '00:00'
                                    ...
                                    <div class="row h5 d-flex align-items-center list-price-item">
                                ...
                                @endif
                                <div class="row h5 mt-1 list-price-item">
                                    <div class="col">
                            ...
                            <div class="text-center mt-2">
                                {{-- If filter search of datetime is working --}}
                                {{-- @if ($parking_place->isReservationPossible())
                                    <a
                                ...
                                <a
                                    href="{{ route('showReservationForm', $parking_place->id) }}"
                                    class="btn btn-sm rounded-pill px-5 btn-orange fw-bold fs-5 reserve-button"
                                >
                                    Reserve now
                                </a>
                            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.getElementById('clear_all').addEventListener('click', function() {
                ...
                form.querySelectorAll('input[type="text"], input[type="date"], input[type="checkbox"]').forEach(function(input) {
                    input.value = '';
