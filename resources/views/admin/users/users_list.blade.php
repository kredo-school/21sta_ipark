    ...
    <div class="container">
        <div class="row mt-4">
            <div class="col-2 d-flex align-items-center admin-title-parking">
                <i class="fa-solid fa-car fa-2x page-title"></i>
                <span class="ms-2">
                    <a
                        href="{{ route('admin.parking.parkings_list') }}"
                        class="admin-parking-link"
                    >
                        <span class="admin-parking h4 page-title"> Parking Places</span>
                    </a>
                </span>
            </div>
            <div class="col-2 d-flex align-items-center justify-content-center admin-title-users">
                <i class="fa-solid fa-user fa-2x admin-users-icon page-title"></i>
                <span class="ms-2">
                    <span class="admin-users h4 page-title"> Users</span>
                </span>
            </div>
        </div>
        ...
        <form action="{{ route('admin.users_list')}}" method="get">
            <div class="card user-search mt-3">
                <div class="row justify-content-center">
                    ...
                    <div class="card-body fw-bold h5 usersList-card-body">
                        <div class="row">
                            <div class="col-md-5 admin-search-group">
                            ...
                            <div class="col-md-6 ms-3 admin-search-group-r">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-6 ms-3 select-icon admin-search-group-r">
                        ...
                        <div class="row my-4">
                            ...
                            <div class="col-md-6 ms-3 admin-search-group-r">
                                <div class="d-flex user-apply-btn">
                                    <a
