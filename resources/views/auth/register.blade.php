...
@section('content')
    ...
    <!-- Modal -->
    <div class="modal fade custom-modal" id="successModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <button type="button" id="continueButton" class="btn">Continue</button>
            </div>
        </div>
        </div>
    </div>
